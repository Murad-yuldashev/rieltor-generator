...
RUN yarn workspace @rieltor/crm build
...
# The developer CRM SPA — configureApp() serves it from apps/api/dist at ../../crm/dist.
COPY --from=build /app/apps/crm/dist ./apps/crm/dist
COPY package.json ./
