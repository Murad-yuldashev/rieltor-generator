 ...
 * triggered from many places — the site header, and any feature that needs an
 * anonymous visitor to sign in first (e.g. tracking a valuation). Holding the
 * open flag at module level and broadcasting through useSyncExternalStore lets
 * any layer call `openLoginModal()` without threading modal state through props.
 *
