...
const PATHS = {
  ...
  /** A chat bubble — the lead-form CTA ("Raqamimni qoldiraman") and its cabinet
   *  entry point (design spec §8.4). */
  message: [
    'M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H9l-4 4v-4H5a2 2 0 0 1-2-2V5Z',
    'M7 9h10M7 12.5h6',
  ],
} as const;
