...
import { AGENCY, FAQ } from '@/shared/config/agency';
    ...
    <main>
      ...
      <div className="flex flex-col gap-3.5 p-4">
        <SectionCard className="py-6 text-center">
          ...
          <h2 className="mt-3.5 text-[19px] font-extrabold tracking-tight">{AGENCY.name}</h2>
        ...
        <SectionCard className="py-1">
          <Link to="/offer" className="flex items-center gap-3 py-3.5">
            ...
            <span className="min-w-0 flex-1">
              <span className="block text-[14.5px] font-bold">Ommaviy oferta</span>
