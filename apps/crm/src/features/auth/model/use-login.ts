 ...
 * any re-render re-evaluates `enabled`) does nothing — the shell would keep
 * showing the login gate until a navigation. Seeding the cache notifies the
 * observer immediately, so the shell switches to the cabinet right away.
 */
